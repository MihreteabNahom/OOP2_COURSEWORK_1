...
public class OOPCourseWork1 {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		Scanner result= new Scanner(System.in);
		double WEBDESIGN,OOP,PROBLEMSOLVING,COMPUTERAPLLICATION,COMPUTERSYSTEMS,COMMUNICATIONSKILLS,ENT,MATHS,TOTAL,AVERAGE;
		...
		while(OOP<0||OOP>100){
		     ...
		     System.out.println("Enter your PROBLEMSOLVING marks" +"");
